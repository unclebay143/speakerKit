      ...
      <div className="space-y-4">       
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              id="shortBio"
              placeholder="Brief introduction for quick references"
          ...
          <div className="space-y-2">
            ...
            <Textarea
              id="mediumBio"
              placeholder="Detailed bio for professional introductions"
            ...
            />
            <p className="text-xs text-gray-400 text-right">{profileData.mediumBio.length}/500 characters</p>
          </div>

          {/* Long Bio */}
          <div className="space-y-2">
            <Label htmlFor="longBio" className="text-white text-sm">
              Long Bio (Full biography)
            </Label>
            <Textarea
              id="longBio"
            ...
            />
            <p className="text-xs text-gray-400 text-right">{profileData.longBio.length}/1000 characters</p>
          </div>
        </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">
                {isPublic ? "Public - Anyone can view this profile" : "Private - Only you can view this profile"}
              </p>
            </div>
          </div>
