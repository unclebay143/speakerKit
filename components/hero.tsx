    ...
    <div className="relative min-h-[calc(100vh-76px)] flex items-center">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Create multiple bio versions, manage headshots, and share your speaker profile effortlessly. Perfect for
          ...
          >
            ...
            <Link href='/signup' className="bg-purple-600 hover:bg-purple-700 text-white px-8">
